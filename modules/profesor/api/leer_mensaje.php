...
// (defensa extra, ver TenantGuard::assertOwner de otras pantallas).
// id_estudiante_remitente: si quien escribió es un estudiante (siempre el
// caso cuando el profesor está viendo un mensaje recibido), permite al JS
