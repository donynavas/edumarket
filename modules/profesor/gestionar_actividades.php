        ...
        if ($accion == 'crear') {
            ...
            if ($asignacionInfo && !empty($titulo)) {
                ...
                foreach ($targets as $t) {
                    try {
                        $db->beginTransaction();
                        ActividadHelper::crearActividadEnAsignacion(
            ...
            if ($actividadActual && !empty($titulo)) {
                ...
                $vinculo = ActividadHelper::resolverVinculoCuadroNotas($db, $tid, $id_asignacion, (int) $actividadActual['anno'], $actividadActual['nivel'], $id_periodo_post, $casilla_post, $id_actividad);
...
// de todas las asignaciones. Ver ActividadHelper::resolverVinculoCuadroNotas(),
// que sí revalida contra la asignación REAL de la actividad al guardar.
...
// ActividadHelper::copiarRubricaATactividad() al guardar.
                ...
                <form method="POST" id="formActividad">
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <?php $idPrefix = ''; require __DIR__ . '/partials/bloque_cuadro_notas.php'; ?>
                        </div>
                    </div>
